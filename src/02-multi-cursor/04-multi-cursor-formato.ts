...
/* Para lograrlo, luego de seleccionar debe ir manualmente dandole formato, pero en cuanto
   el = se alinie con el de abajo, utilizar muticursores para hacerlo más facil
*/
